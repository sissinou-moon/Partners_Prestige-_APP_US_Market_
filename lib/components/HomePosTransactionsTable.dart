...
class PosTransactionsTable extends ConsumerWidget {
  final String partnerId;
  final String? branchId;
  final int maxVisibleItems; // Control how many items to show before scrolling
  final double maxHeight; // Maximum height before enabling scroll

  const PosTransactionsTable({
    super.key,
    required this.partnerId,
    this.branchId,
    this.maxVisibleItems = 5, // Show 5 items by default
    this.maxHeight = 500, // Maximum 500px height
  });
  ...
  Widget _buildTransactionsList(List<Map<String, dynamic>> transactions) {
    ...
    final int itemsToShow = transactions.length > maxVisibleItems
        ? maxVisibleItems
        : transactions.length;
    ...
    return ConstrainedBox(
      constraints: BoxConstraints(
        ...
        minHeight: itemHeight, // At least one item height
      ),
      child: ListView.separated(
        shrinkWrap: true,
        physics: transactions.length > maxVisibleItems
